        ...
        <div class="flex flex-wrap mb-24 -mx-3">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                ...
                <li class="mb-4">
                    ...
                    <input type="checkbox" id="featured" wire:model.live="is_featured" value="1" class="w-4 h-4 mr-2">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                ...
                <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                <div>
                    <div class="font-semibold dark:text-white">{{ Number::currency($price_range)}}</div>
                <input type="range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" wire:model.live="price_range" max="500000" value="300000" step="1000">
                ...
                <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex dark:bg-gray-900 ">
                    <div class="flex items-center gap-4 justify-between w-full">
                        ...
                        <select wire:model.live="sort"
                                class="block w-40 text-base bg-gray-100 cursor-pointer dark:text-gray-400 dark:bg-gray-900 rounded-md border border-gray-300 px-2 py-1">
                        ...
                        <input type="text"
                            ...
                            class="block w-64 text-base bg-white dark:bg-gray-800 dark:text-gray-300 border border-gray-300 rounded-md px-3 py-1 focus:ring focus:ring-indigo-400 focus:outline-none">
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-wrap items-center ">
                ...
                @foreach ($products as $product)
                    ...
                    <div class="border border-gray-300 dark:border-gray-700">
                        ...
                        <a href="/products/{{$product->slug}}" wire:navigate class="">
