<div>
    ...
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
            <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Peter X Software</span></h1>
            ...
            <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="{{ $websiteSetting->whatsApp }}">
                <img src="{{ asset('storage/WhatsApp.svg') }}" alt="WhatsApp" class="w-7 h-7">
                Contact sales team
            </a>
            </div>
            <!-- End Buttons -->
            ...
            <div class="py-5">
                ...
                <svg class="h-4 w-4 text-gray-800 dark:bg-white" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M27.0352 1.6307L33.9181 16.3633C34.2173 16.6768 34.5166 16.9903 34.8158 16.9903L50.0779 19.1845C50.9757 19.1845 51.275 20.4383 50.6764 21.0652L39.604 32.3498C39.3047 32.6632 39.3047 32.9767 39.3047 33.2901L41.998 49.2766C42.2973 50.217 41.1002 50.8439 40.5017 50.5304L26.4367 43.3208C26.1375 43.3208 25.8382 43.3208 25.539 43.3208L11.7732 50.8439C10.8754 51.1573 9.97763 50.5304 10.2769 49.59L12.9702 33.6036C12.9702 33.2901 12.9702 32.9767 12.671 32.6632L1.29923 21.0652C0.700724 20.4383 0.999979 19.4979 1.89775 19.4979L17.1598 17.3037C17.459 17.3037 17.7583 16.9903 18.0575 16.6768L24.9404 1.6307C25.539 0.69032 26.736 0.69032 27.0352 1.6307Z" fill="currentColor" />
                </svg>
                <svg class="h-4 w-4 text-gray-800 dark:bg-white" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M27.0352 1.6307L33.9181 16.3633C34.2173 16.6768 34.5166 16.9903 34.8158 16.9903L50.0779 19.1845C50.9757 19.1845 51.275 20.4383 50.6764 21.0652L39.604 32.3498C39.3047 32.6632 39.3047 32.9767 39.3047 33.2901L41.998 49.2766C42.2973 50.217 41.1002 50.8439 40.5017 50.5304L26.4367 43.3208C26.1375 43.3208 25.8382 43.3208 25.539 43.3208L11.7732 50.8439C10.8754 51.1573 9.97763 50.5304 10.2769 49.59L12.9702 33.6036C12.9702 33.2901 12.9702 32.9767 12.671 32.6632L1.29923 21.0652C0.700724 20.4383 0.999979 19.4979 1.89775 19.4979L17.1598 17.3037C17.459 17.3037 17.7583 16.9903 18.0575 16.6768L24.9404 1.6307C25.539 0.69032 26.736 0.69032 27.0352 1.6307Z" fill="currentColor" />
                ...
                <p class="mt-3 text-sm text-gray-800 dark:bg-white">
        ...
        <div class="relative ms-4">
            <img class="w-full rounded-md" src="{{ url('storage',$websiteSetting->main_logo)}}" alt="Image Description">
    ...
    <section class="relative py-20 bg-cover bg-center" style="background-image: url('{{ asset('storage/ADS_Section.jpg') }}');">
        <div class="absolute inset-0 bg-black/50"></div>
        <div class="relative z-10 max-w-xl mx-auto text-center text-white">
            <h1 class="text-5xl font-bold">
            Our Latest <span class="text-blue-300">Ads</span>
            </h1>
            ...
            Discover our latest offers and promotions — don’t miss out!
            </p>
        </div>

        <div class="relative z-10 max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-1 lg:grid-cols-2">
            @foreach ($ads as $ad)
                <div class="bg-white rounded-lg shadow-md dark:bg-gray-800 hover:-mt-4 hover:mb-4 cursor-pointer transition-all duration-300 ease-in-out">
                <a href="{{ $ad->link }}" target="_blank">
                    <img src="{{ url('storage', $ad->image) }}"
                        alt="{{ $ad->title }}"
                        class="object-cover w-full h-96 rounded-t-lg">
                </a>
                <div class="p-5 text-center">
                    <a href="{{ $ad->link }}" target="_blank"
                    class="text-2xl font-bold tracking-tight text-gray-900 hover:text-blue-600 dark:text-white dark:hover:text-blue-500">
                    {{ $ad->title }}
                    </a>
                    @if($ad->description)
    ...
    <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
        ...
        @foreach ($brands as $brand)
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800  hover:-mt-4 hover:mb-4 dark:hover:text-blue-500 cursor-pointer transition-all duration-300 ease-in-out">
                ...
                <div class="p-5 text-center dark:hover:text-blue-500">
                    <a wire:navigate href="/products?selected_brands[0]={{$brand->id}}" class="text-2xl hover:text-blue-600 dark:hover:text-blue-500 font-bold tracking-tight text-gray-900 dark:text-white">
                        {{$brand->name}}
                    </a>
                </div>
            </div>
    ...
    <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        @foreach ($categories as $category)
            <a wire:navigate class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600  hover:-mt-4 hover:mb-4 cursor-pointer transition-all duration-300 ease-in-out" href="/products?selected_categories[0]={{$category->id}}">
                <div class="p-4 md:p-5">
                <div class="flex justify-between items-center">
                    <div class="flex items-center">
                    <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{url('storage',$category->image)}}" alt=" {{$category->name}}">
                    <div class="ms-3">
                        <h3 class="group-hover:text-blue-600 font-semibold text-gray-800 dark:group-hover:text-blue-500 dark:text-white">
                        {{$category->name}}
                        </h3>
                    </div>
                    </div>
                    <div class="ps-3 dark:text-white dark:group-hover:text-blue-500">
    ...
    {{-- review section start here --}}
        <section class="py-14 font-poppins dark:bg-gray-800">
            <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
                ...
                <div class="text-center ">
                    <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200"> Products <span class="text-blue-500"> Recommended
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                        </div>
                ...
                @foreach ($products as $product)
                    <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3 hover:-mt-6 hover:mb-6 cursor-pointer transition-all duration-300 ease-in-out">
                    <div class="border border-gray-300 dark:border-gray-700">
                        <div class="relative bg-gray-200">
                        <a href="/products/{{$product->product->slug}}" wire:navigate class="">
                            <img src="{{url('storage',$product->product->images[0])}}" alt="" class="object-cover w-full h-56 mx-auto ">
                        </a>
                        </div>
                        <div class="p-3 ">
                        ...
                        <p class="text-lg ">
                            <span class="text-green-600 dark:text-green-600">{{ Number::currency($product->product->price)}}</span>
                        </p>
                        </div>
                        <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">

                        <a href="#"  wire:click.prevent="addToCart({{$product->product->id}})" class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
                            ...
                            </svg><span wire:loading.remove wire:target='addToCart({{$product->product->id}})'>Add to Cart</span><span wire:loading wire:target='addToCart({{$product->product->id}})'>Adding ..</span>
                        </a>
