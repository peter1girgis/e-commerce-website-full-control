    ...
    <div class="flex flex-col bg-white dark:bg-gray-400 p-5 rounded mt-4 shadow-lg ">
        ...
        <div class="p-1.5 min-w-full inline-block align-middle ">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 ">
                ...
                <tbody >
                    ...
                    @endphp
                        <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800 " wire:key="{{$order->id}}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $order->created_at->format('Y-m-d')}}</td>
                ...
                {{-- <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                    <a wire:navigate href="{{asset('/my-orders/1')}}" class="bg-slate-600 text-white py-2 px-4 rounded-md hover:bg-slate-500">View Details</a>
                    </td>
                </tr> --}}
